...
card and lifecycle rail, and the deck lens draws its four piles; shipshape is
still a placeholder. All three sit over a frozen document shape, filled from
synthetic fixtures rather than a real fleet.
