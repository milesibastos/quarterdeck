...
| The deck and shipshape lenses | Red | Placeholders mounted in the shell, each in its own directory, each handed its part of the document. Nothing is drawn yet - deliberately: the lens content is the next four workers' job, and the seam they build against is what this task froze. |
